...
@section('content')
    ...
    <p style="margin:0 0 20px; font-size:15px; color:#475569; line-height:1.6;">Great news! Someone used your referral code to join radiantdreamrealty. You've earned a referral bonus!</p>
    ...
    <p style="margin:12px 0 0; font-size:14px; color:#64748b; line-height:1.5;">Keep investing and growing with radiantdreamrealty!</p>
@endsection
