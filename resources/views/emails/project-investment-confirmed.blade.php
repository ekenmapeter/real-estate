...
@section('content')
        ...
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr><td style="padding-bottom:10px;"><span style="font-size:13px; color:#64748b;">Amount Invested</span></td><td style="padding-bottom:10px; text-align:right;"><span style="font-size:16px; font-weight:700; color:#2563eb;">{{ format_avc($investment->amount) }}</span></td></tr>
                    <tr><td style="padding-bottom:10px;"><span style="font-size:13px; color:#64748b;">Expected Return ({{ $investment->project->expected_return_percentage }}%)</span></td><td style="padding-bottom:10px; text-align:right;"><span style="font-size:14px; font-weight:700; color:#16a34a;">{{ format_avc($investment->expected_roi_amount) }}</span></td></tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr><td align="center" style="padding-top:24px;"><a href="{{ route('portfolio.index') }}" style="display:inline-block; background:linear-gradient(135deg,#2563eb,#1d4ed8); color:#fff; font-size:15px; font-weight:700; padding:14px 36px; border-radius:10px; text-decoration:none;">View My Portfolio</a></td></tr>
    </table>
@endsection
