        ...
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr><td style="padding-bottom:10px;"><span style="font-size:13px; color:#64748b;">Total Invested</span></td><td style="padding-bottom:10px; text-align:right;"><span style="font-size:16px; font-weight:700; color:#2563eb;">${{ number_format($investment->total_amount, 2) }}</span></td></tr>
                    <tr><td style="padding-bottom:10px;"><span style="font-size:13px; color:#64748b;">Expected ROI</span></td><td style="padding-bottom:10px; text-align:right;"><span style="font-size:14px; font-weight:700; color:#16a34a;">${{ number_format($investment->expected_roi_amount, 2) }}</span></td></tr>
