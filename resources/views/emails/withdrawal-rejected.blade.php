...
@section('content')
    ...
    <p style="margin:0 0 20px; font-size:15px; color:#475569; line-height:1.6;">Your withdrawal request has been rejected and the funds have been returned to your wallet.</p>

    <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef2f2; border-radius:12px; padding:20px;">
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr><td style="padding-bottom:10px;"><span style="font-size:13px; color:#64748b;">Amount</span></td><td style="padding-bottom:10px; text-align:right;"><span style="font-size:14px; font-weight:700; color:#0f172a;">${{ number_format($withdrawal->amount, 2) }}</span></td></tr>
