...
@section('content')
    ...
    <p style="margin:0 0 20px; font-size:15px; color:#475569; line-height:1.6;">Your deposit has been approved and the funds have been credited to your AVC balance.</p>
        ...
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr><td style="padding-bottom:10px;"><span style="font-size:13px; color:#64748b;">Amount Credited</span></td><td style="padding-bottom:10px; text-align:right;"><span style="font-size:16px; font-weight:700; color:#16a34a;">+{{ format_avc($deposit->amount) }}</span></td></tr>
